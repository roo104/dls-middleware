...
public class AgreementPackageCq implements Serializable {
	...
	@JsonProperty("removedCoversCollection")
	private List<AgreementCoverIdCq> removedCoversCollection = new ArrayList<AgreementCoverIdCq>();
	...
	public AgreementPackageCq addRemovedCoversCollectionItem(AgreementCoverIdCq removedCoversCollectionItem) {
		this.removedCoversCollection.add(removedCoversCollectionItem);
		return this;
	}
	
	public List<AgreementCoverIdCq> getRemovedCoversCollection() {
		return removedCoversCollection;
	}
	
	public void setRemovedCoversCollection(List<AgreementCoverIdCq> removedCoversCollection) {
		this.removedCoversCollection = removedCoversCollection;
	}
}
