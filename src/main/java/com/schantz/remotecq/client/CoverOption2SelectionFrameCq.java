...
public class CoverOption2SelectionFrameCq implements Serializable {
	...
	public CoverOption2SelectionFrameCq addOptionCollectionItem(String optionCollectionItem) {
