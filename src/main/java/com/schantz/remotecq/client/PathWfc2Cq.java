...
public class PathWfc2Cq implements Serializable {
	...
	private AbstractWfc2Cq nextElement = null;
	...
	public PathWfc2Cq addConfigurationFieldCqCollectionItem(ConfigurationFieldCq configurationFieldCqCollectionItem) {
	...
	public AbstractWfc2Cq getNextElement() {
		return nextElement;
	}
	
	public void setNextElement(AbstractWfc2Cq nextElement) {
