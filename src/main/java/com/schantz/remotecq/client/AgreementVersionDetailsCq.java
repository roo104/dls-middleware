...
public class AgreementVersionDetailsCq implements Serializable {
  ...
  @JsonProperty("defaultNoPoliciesForced")
  private BooleanTripletCq defaultNoPoliciesForced = null;
  ...
  public BooleanTripletCq getDefaultNoPoliciesForced() {
    return defaultNoPoliciesForced;
  }

  public void setDefaultNoPoliciesForced(BooleanTripletCq defaultNoPoliciesForced) {
    this.defaultNoPoliciesForced = defaultNoPoliciesForced;
  }
