...
public class RetrieveAllClaimRelevantDeathCoversQueryResult implements Serializable {
	...
	public RetrieveAllClaimRelevantDeathCoversQueryResult addPreparedLocksItem(CqLock preparedLocksItem) {
	...
	public RetrieveAllClaimRelevantDeathCoversQueryResult addPolicyIdCqCollectionItem(PolicyIdCq policyIdCqCollectionItem) {
