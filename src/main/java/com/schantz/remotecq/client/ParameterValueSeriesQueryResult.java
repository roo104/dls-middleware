...
public class ParameterValueSeriesQueryResult implements Serializable {
  ...
  public ParameterValueSeriesQueryResult addPreparedLocksItem(CqLock preparedLocksItem) {
  ...
  public ParameterValueSeriesQueryResult addParameterValueCqCollectionItem(ParameterValueCq parameterValueCqCollectionItem) {
