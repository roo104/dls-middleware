...
public class PolicyOption2SelectionFrameCq implements Serializable {
  ...
  public PolicyOption2SelectionFrameCq addOptionCollectionItem(String optionCollectionItem) {
