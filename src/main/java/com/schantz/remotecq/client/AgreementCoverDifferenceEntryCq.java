...
public class AgreementCoverDifferenceEntryCq implements Serializable {
	...
	public AgreementCoverDifferenceEntryCq addKeyValueCollectionItem(CqSerializable keyValueCollectionItem) {
	...
	public AgreementCoverDifferenceEntryCq addValueCollectionItem(CqSerializable valueCollectionItem) {
