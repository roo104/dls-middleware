...
public class AgreementVersionDifferenceEntryCq implements Serializable {
	...
	public AgreementVersionDifferenceEntryCq addKeyValueCollectionItem(CqSerializable keyValueCollectionItem) {
	...
	public AgreementVersionDifferenceEntryCq addValueCollectionItem(CqSerializable valueCollectionItem) {
