...
public class UserSearchQueryResult implements Serializable {
  @JsonProperty("preparedLocks")
  private List<CqLock> preparedLocks = new ArrayList<CqLock>();

  @JsonProperty("entryCollection")
  private List<UserInfoCq> entryCollection = new ArrayList<UserInfoCq>();
  ...
  public UserSearchQueryResult addPreparedLocksItem(CqLock preparedLocksItem) {
  ...
  public UserSearchQueryResult addEntryCollectionItem(UserInfoCq entryCollectionItem) {
    this.entryCollection.add(entryCollectionItem);
    return this;
  }

  public List<UserInfoCq> getEntryCollection() {
    return entryCollection;
  }

  public void setEntryCollection(List<UserInfoCq> entryCollection) {
