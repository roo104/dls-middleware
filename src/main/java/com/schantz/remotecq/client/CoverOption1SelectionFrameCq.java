...
public class CoverOption1SelectionFrameCq implements Serializable {
  ...
  public CoverOption1SelectionFrameCq addOptionCollectionItem(String optionCollectionItem) {
