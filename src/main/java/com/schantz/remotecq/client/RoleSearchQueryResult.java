...
public class RoleSearchQueryResult implements Serializable {
	...
	public RoleSearchQueryResult addPreparedLocksItem(CqLock preparedLocksItem) {
	...
	public RoleSearchQueryResult addEntryCollectionItem(RoleInfoCq entryCollectionItem) {
