...
public class CompensationQueryCompensationQueryResult implements Serializable {
	...
	public CompensationQueryCompensationQueryResult addPortfolioIdCollectionItem(PortfolioIdCq portfolioIdCollectionItem) {
