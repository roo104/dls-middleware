...
public class SplitPortfolioQuerySplitPortfolioQueryResult implements Serializable {
  ...
  public SplitPortfolioQuerySplitPortfolioQueryResult addPortfolioIdCollectionItem(PortfolioIdCq portfolioIdCollectionItem) {
