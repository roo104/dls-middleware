...
public class PolicyOption3SelectionFrameCq implements Serializable {
  ...
  public PolicyOption3SelectionFrameCq addOptionCollectionItem(String optionCollectionItem) {
