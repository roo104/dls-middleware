...
public class LifeCaseStateSelectionFrameCq implements Serializable {
	...
	public LifeCaseStateSelectionFrameCq addOptionCollectionItem(String optionCollectionItem) {
