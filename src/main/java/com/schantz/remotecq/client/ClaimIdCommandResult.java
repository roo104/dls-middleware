...
public class ClaimIdCommandResult implements Serializable {
	...
	public ClaimIdCommandResult addPreparedLocksItem(CqLock preparedLocksItem) {
	...
	public ClaimIdCommandResult addStatusMessagesItem(CommandStatusMessage statusMessagesItem) {
