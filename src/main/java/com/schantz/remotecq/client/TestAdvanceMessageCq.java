...
public class TestAdvanceMessageCq implements Serializable {
	...
	public TestAdvanceMessageCq addOperationHistoryCollectionItem(QueueOperationCq operationHistoryCollectionItem) {
