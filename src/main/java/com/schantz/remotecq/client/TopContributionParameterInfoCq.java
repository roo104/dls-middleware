...
public class TopContributionParameterInfoCq implements Serializable {
  ...
  @JsonProperty("isSubscribedToBetalingsservice")
  private Boolean isSubscribedToBetalingsservice = false;
  ...
  public Boolean getIsSubscribedToBetalingsservice() {
    return isSubscribedToBetalingsservice;
  }

  public void setIsSubscribedToBetalingsservice(Boolean isSubscribedToBetalingsservice) {
    this.isSubscribedToBetalingsservice = isSubscribedToBetalingsservice;
  }
