...
public class QuoteSearchQueryResult implements Serializable {
  @JsonProperty("preparedLocks")
  private List<CqLock> preparedLocks = new ArrayList<CqLock>();

  @JsonProperty("entryCollection")
  private List<QuoteCq> entryCollection = new ArrayList<QuoteCq>();
  ...
  public QuoteSearchQueryResult addPreparedLocksItem(CqLock preparedLocksItem) {
  ...
  public QuoteSearchQueryResult addEntryCollectionItem(QuoteCq entryCollectionItem) {
    this.entryCollection.add(entryCollectionItem);
    return this;
  }

  public List<QuoteCq> getEntryCollection() {
    return entryCollection;
  }

  public void setEntryCollection(List<QuoteCq> entryCollection) {
