...
public class BatchActualScheduleListExportQueryResult implements Serializable {
	...
	public BatchActualScheduleListExportQueryResult addPreparedLocksItem(CqLock preparedLocksItem) {
