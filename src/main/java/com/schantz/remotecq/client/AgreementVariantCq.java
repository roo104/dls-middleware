...
public class AgreementVariantCq implements Serializable {
	...
	@JsonProperty("allowChangeLife1")
	private BooleanTripletCq allowChangeLife1 = null;
	
	@JsonProperty("triggeredBenefitHandlerTripletCq")
	private TriggeredBenefitHandlerTripletCq triggeredBenefitHandlerTripletCq = null;
	...
	public BooleanTripletCq getAllowChangeLife1() {
		return allowChangeLife1;
	}
	
	public void setAllowChangeLife1(BooleanTripletCq allowChangeLife1) {
		this.allowChangeLife1 = allowChangeLife1;
	}
	
	public TriggeredBenefitHandlerTripletCq getTriggeredBenefitHandlerTripletCq() {
		return triggeredBenefitHandlerTripletCq;
	}
	
	public void setTriggeredBenefitHandlerTripletCq(TriggeredBenefitHandlerTripletCq triggeredBenefitHandlerTripletCq) {
		this.triggeredBenefitHandlerTripletCq = triggeredBenefitHandlerTripletCq;
	}
}
