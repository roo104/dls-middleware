...
public class AgreementEditPerspectiveCq implements Serializable {
	...
	@JsonProperty("isShowAllSectionsAtOnce")
	private Boolean isShowAllSectionsAtOnce = false;
	...
	public Boolean getIsShowAllSectionsAtOnce() {
		return isShowAllSectionsAtOnce;
	}
	
	public void setIsShowAllSectionsAtOnce(Boolean isShowAllSectionsAtOnce) {
		this.isShowAllSectionsAtOnce = isShowAllSectionsAtOnce;
	}
