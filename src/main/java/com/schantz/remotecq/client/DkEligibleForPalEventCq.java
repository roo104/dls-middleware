...
public class DkEligibleForPalEventCq implements Serializable {
  ...
  public DkEligibleForPalEventCq addValidationOverrideCqCollectionItem(ValidationOverrideCq validationOverrideCqCollectionItem) {
