...
public class ClauseSearchQueryResult implements Serializable {
  @JsonProperty("preparedLocks")
  private List<CqLock> preparedLocks = new ArrayList<CqLock>();

  @JsonProperty("entryCollection")
  private List<ClauseCq> entryCollection = new ArrayList<ClauseCq>();
  ...
  public ClauseSearchQueryResult addPreparedLocksItem(CqLock preparedLocksItem) {
  ...
  public ClauseSearchQueryResult addEntryCollectionItem(ClauseCq entryCollectionItem) {
    this.entryCollection.add(entryCollectionItem);
    return this;
  }

  public List<ClauseCq> getEntryCollection() {
    return entryCollection;
  }

  public void setEntryCollection(List<ClauseCq> entryCollection) {
