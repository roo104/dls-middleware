...
public class PolicyOption1SelectionFrameCq implements Serializable {
	...
	public PolicyOption1SelectionFrameCq addOptionCollectionItem(String optionCollectionItem) {
