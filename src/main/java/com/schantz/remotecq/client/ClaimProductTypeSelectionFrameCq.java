...
public class ClaimProductTypeSelectionFrameCq implements Serializable {
	...
	public ClaimProductTypeSelectionFrameCq addOptionCollectionItem(String optionCollectionItem) {
